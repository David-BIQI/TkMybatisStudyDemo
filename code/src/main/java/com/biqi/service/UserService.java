...
//		return null;
    ...
    public Boolean sortTop(Integer userId) {
        User oldUser = userDao.selectByPrimaryKey(userId);
        notNull(oldUser, "用户id:"+userId+" 不存在");
        userDao.makeSortTop(userId);
        return true;
    }
}

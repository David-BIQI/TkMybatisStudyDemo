...
public class UserController {
    ...
    @PostMapping("/user/sortTop/{userId}")
    @ApiOperation(value = "用户排序置顶")
    public ResultDto<Boolean> sortTop(@PathVariable("userId") Integer userId){
        ResultDto<Boolean> resultDto = new ResultDto<>();
        resultDto.setData(userService.sortTop(userId));
        return resultDto;
    }
